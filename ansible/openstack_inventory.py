...
# https://docs.ansible.com/ansible/latest/user_guide/intro_dynamic_inventory.html#implicit-use-of-openstack-inventory-script
# https://raw.githubusercontent.com/ansible/ansible/devel/contrib/inventory/openstack_inventory.py
